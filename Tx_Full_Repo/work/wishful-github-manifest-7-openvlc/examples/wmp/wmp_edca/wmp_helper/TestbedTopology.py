...
class TestbedTopology:
    ...
    def initializeTestbedFunctions(self, controller):
        ...
        self.log.info('***************** %s ***************' % self.initializeTestbedFunctions.__name__)
        ...
        UPIargs = {'execution_engine' : ['runtime/connectors/wmp_linux/execution_engine/wmp'] }
        #UPIargs = {'execution_engine' : ['runtime/connectors/wmp_linux/execution_engine/medca-openfwwf-logcw'] }
